    ...
    <div class="col-8">
        <form action="/student?action=edit" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputName" name="name" placeholder="Enter name" value="${student.name}">
            </div>
            <div class="form-group">
                <label for="inputEmail">Email</label>
                <input type="text" class="form-control" id="inputEmail" name="email" placeholder="Enter email" value="${student.email}">
            </div>
            <div class="form-group">
                <label for="inputDOB">Date of Birth</label>
                <input type="text" class="form-control" id="inputDOB" name="DOB"
                       placeholder="Enter date of birth as DD/MM/YYYY" value="${student.DOB}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idClass">
                    <c:forEach items="${lstClassroom}" var="classroom">
                        <c:choose>
                            <c:when test="${classroom.id == student.id}">
                                <option value="${student.id}" selected>${classroom.name}</option>
                            </c:when>
                            <c:otherwise>
